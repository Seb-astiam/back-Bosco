...
const getReservationsAlojamientoHandler = async (req, res) => {
  ...
  try {
    const reservaciones = await getReservationsAlojamientoController(identificacion);
...
const updateReservationHandler = async (req, res) => {
  ...
  try {
    const estadoReserva = await updateReservationController({ status, id_reserva });
...
module.exports = { postReservationHandler, getAllReservationHandler, getReservationsAlojamientoHandler, updateReservationHandler };
